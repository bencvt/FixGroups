 ...
 * When you need a "volunteer" to handle a certain mechanic in a fight and it doesn't really matter who, simply type **/choose**. You can narrow down the candidate pool by using **/choose ranged**, **/choose hunter**, etc. This command has many other uses as well. Type **/choose help** in-game for details.
