...
L["gui.fixGroups.intro"] = "The %s (or %s) command allows you to control the addon from the chat console. You can use it in a macro, type it in chat, or just use the GUI if you prefer."
...
L["options.widget.notifyNewVersion.desc"] = "When someone else in the raid is running a newer version of %s, put a reminder in the chat frame. This notification will only happen once per session. It will look like:"
