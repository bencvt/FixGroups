...
L["gui.fixGroups.help.note.core.1"] = "Bench (i.e., move to group 8) all <%s> guild members below %s (rank %d)."
L["gui.fixGroups.help.note.core.2"] = "You can adjust the rank to the config."
...
L["options.widget.coreRaiderMinimumRank.text"] = "Minimum <%s> guild rank to not be benched by the %s sort method"
...
L["options.widget.notifyNewVersion.desc"] = "When someone else in the raid is running a newer version of %s, put a reminder in the chat frame. This notification will only happen once per session."
...
L["sorter.mode.core"] = "core raiders only"
