...
L["button.fixGroupsHelp.desc.1"] = "Команда %s (или %s) позволяет контролировать аддон, не используя графический интерфейс. Ее можно использовать в макросе или просто набирать в чат." -- Needs review
L["button.fixGroupsHelp.desc.2"] = "Нажмите эту кнопку, чтобы запустить %s, который покажет возможные параметры." -- Needs review
...
L["chatKeyword.fixGroups"] = "перестройте группы" -- Needs review
L["chatKeyword.markTanks"] = "отметьте танков" -- Needs review
...
L["choose.gui.header.buttons"] = "Параметры команды %s" -- Needs review
L["choose.gui.header.examples"] = "Примеры команды %s в действии" -- Needs review
L["choose.gui.intro"] = "Необходимо подкинуть монетку, чтобы принять решение? Используйте команду %s, чтобы выбрать вариант или игрока случайным образом. Выбор будет мгновенным, прозрачным и честным благодаря встроенной в Вов команде /roll." -- Needs review
L["choose.gui.note.multipleClasses"] = "Вы также можете указать несколько классов, например: %s." -- Needs review
L["choose.gui.note.option.1"] = "Чтобы выбрать из набора произвольных вариантов, просто перечислите их после команды %s." -- Needs review
L["choose.gui.note.option.2"] = "Вы можете использовать запятые или пробелы, чтобы разделять варианты." -- Needs review
L["choose.gui.title"] = "команда %s" -- Needs review
...
L["choose.print.choosing.alive"] = "Выбираем случайного выжившего..." -- Needs review
L["choose.print.choosing.any"] = "Выбираем случайного игрока..." -- Needs review
L["choose.print.choosing.anyIncludingSitting"] = "Выбираем случайного игрока, включая игроков на замене..." -- Needs review
L["choose.print.choosing.armor"] = "Выбираем случайного игрока, носящего %s (%s)..." -- Needs review
...
L["choose.print.choosing.dead"] = "Выбираем случайного мертвого игрока..." -- Needs review
L["choose.print.choosing.fromGroup"] = "Выбираем случайного игрока из группы %d..." -- Needs review
L["choose.print.choosing.group"] = "Выбираем случайную группы с игроками в ней..." -- Needs review
L["choose.print.choosing.guildmate"] = "Выбираем случайного члена гильдии %s в группе..." -- Needs review
L["choose.print.choosing.guildmate.noGuild"] = "Выбираем случайного гильдейца в группе..." -- Needs review
L["choose.print.choosing.healer"] = "Выбираем случайного целителя..." -- Needs review
L["choose.print.choosing.last"] = "Повторяем последнюю команду %s..." -- Needs review
L["choose.print.choosing.melee"] = "Выбираем случайного игрока ближнего боя..." -- Needs review
L["choose.print.choosing.notMe"] = "Выбираем случайного игрока, отличного от %s..." -- Needs review
L["choose.print.choosing.option"] = "Выбираем случайный вариант из предложенных..." -- Needs review
L["choose.print.choosing.primaryStat"] = "Выбираем случайного игрока, использующего %s (%s)..." -- Needs review
L["choose.print.choosing.ranged"] = "Выбираем случайного игрока дальнего боя..." -- Needs review
L["choose.print.choosing.sitting"] = "Выбираем случайного игрока из групп %d-8..." -- Needs review
L["choose.print.choosing.sitting.noGroups"] = "Выбираем случайного игрока на замене..." -- Needs review
L["choose.print.choosing.tank"] = "Выбираем случайного танка..." -- Needs review
L["choose.print.choosing.tierToken"] = "Выбираем случайного %s (%s)..." -- Needs review
...
L["console.help.blank"] = "перестроить группы" -- Needs review
L["console.help.cancel"] = "остановить перестановку игроков" -- Needs review
L["console.help.config"] = "то же самое, что и Esc -> Интерфейс -> Аддоны -> %s" -- Needs review
L["console.help.header"] = "Возможные параметры для комманды %s (или %s):" -- Needs review
L["console.help.help"] = "вы сейчас его читаете" -- Needs review
L["console.help.meter"] = "перестроить группы, сортируя по общему урону и исцелению" -- Needs review
L["console.help.nosort"] = "перестроить группы без сортировки" -- Needs review
L["console.help.seeChoose"] = "выбирает случайного игрока или случайный вариант из списка, см %s" -- Needs review
L["console.help.split"] = "разделить на 2 равные группы исходя из общего урона/исцеления" -- Needs review
...
L["dataBroker.groupComp.name"] = "Композиция рейда" -- Needs review
L["dataBroker.groupComp.notInGroup"] = "не в группе" -- Needs review
L["dataBroker.groupComp.openRaidTab"] = "Открыть вкладку рейда" -- Needs review
L["dataBroker.groupComp.sitting"] = "На замене в группах %d-8" -- Needs review
...
L["options.header.uiAndChat"] = "Отображение интерфейса и оповещения в чат" -- Needs review
...
L["options.widget.sortMode.desc.1"] = "Метод сортировки по суммарному урону/исцелению будет работать только если работает %s." -- Needs review
L["options.widget.sortMode.desc.2"] = "Этот метод сортировки может быть полезен для принятия быстрых решений, кто достоин экстренного исцеления или батлреса в незнакомой группе." -- Needs review
L["options.widget.sortMode.desc.3"] = "Вы также можете набрать %s или shift + правой кнопкой мыши по иконке у миникарты (или по кнопке %s), чтобы сделать однократную сортировку не меняя настройки." -- Needs review
...
L["options.widget.sysMsgLabel.name"] = "Системное сообщение, появляющееся когда игрок вступает в группу или покидает группу может быть изменено, чтобы сделать его более информативным. Например:" -- Needs review
...
L["sorter.print.excludedSitting.plural"] = "Исключены %d игроков, находящихся в группах %d-8." -- Needs review
L["sorter.print.excludedSitting.singular"] = "Исключен игрок, находящийся в группах %d-8." -- Needs review
L["sorter.print.meter"] = "Переставлено согласно суммарному урону/исцелению." -- Needs review
L["sorter.print.needRank"] = "Вы должны быть лидером рейда или помощником, чтобы менять группы." -- Needs review
-- L["sorter.print.split"] = ""
L["sorter.print.THMUR"] = "Переставлено в порядке танки>хилы>ближний бой>дальний бой." -- Needs review
...
L["sorter.print.TMURH"] = "Переставлено в порядке танки>ближний бой>дальний бой>хилы." -- Needs review
