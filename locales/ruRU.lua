...
L["choose.print.choosing.sitting"] = "игрока из групп %d-8" -- Needs review
...
L["choose.print.last"] = "Повторяем последнюю команду %s."
...
L["gui.fixGroups.help.config"] = "То же самое, что и Esc -> Интерфейс -> Аддоны -> %s."
-- L["gui.fixGroups.help.list"] = ""
-- L["gui.fixGroups.help.listself"] = ""
L["gui.fixGroups.help.nosort"] = "Перестроить группы без сортировки." -- Needs review
...
L["gui.fixGroups.help.note.meter.3"] = "Вы также можете набрать %s чтобы сделать однократную сортировку не меняя настройки."
