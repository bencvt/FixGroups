...
L["choose.list.tooltip"] = "Listet jeden/jedes %s auf." -- Needs review
...
L["gui.fixGroups.help.note.sameAsLeftClicking"] = "Ist das gleiche wie ein Linksklick auf das das Minikarten-Symbol oder den %s Button im Schlachtzug-Reiter."
