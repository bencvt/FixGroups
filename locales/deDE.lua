...
L["button.fixGroupsHelp.desc.1"] = "Der %s (oder %s) Befehl erlaubt dir, das Addon ohne Verwendung des GUIs zu steuern. Du kannst diesen Befehln in einem Makro verwenden oder du gibst ihn einfach in den Chat ein." -- Needs review
L["button.fixGroupsHelp.desc.2"] = "Klicke auf diesen Button, um %s auszuführen, dieses Befehl wird dir die verschiedenen Argumente anzeigen." -- Needs review
...
L["choose.classAliases.warlock"] = "Hexen"
L["choose.classAliases.warrior"] = "Krieg"
...
L["choose.print.choosing.armor"] = "Ein zufälliger %s-Träger wird gerade ausgewählt (%s)..." -- Needs review
...
L["choose.print.choosing.fromGroup"] = "Ein zufälliger Spieler aus der Gruppe %d wird gerade ausgewählt..." -- Needs review
L["choose.print.choosing.group"] = "Eine zufällige Gruppe, die Spieler enthält, wird gerade ausgewählt..." -- Needs review
L["choose.print.choosing.guildmate"] = "Ein zufälliges Gildenmitglied von <%s> wird gerade ausgewählt..." -- Needs review
...
L["dataBroker.groupComp.notInGroup"] = "nicht in einer Gruppe" -- Needs review
L["dataBroker.groupComp.openRaidTab"] = "Schlachtzug-Tab öffnen" -- Needs review
...
L["options.widget.dataBrokerGroupCompStyle.desc.2"] = "Es gibt eine Menge Data-Broker-Anzeigeaddons. Einige der beliebtesten sind %s." -- Needs review
-- L["options.widget.dataBrokerGroupCompStyle.text"] = ""
L["options.widget.enhanceGroupRelatedSystemMessages.desc.1"] = "Wenn diese Option aktiviert ist, wird die Systemnachricht, die auftaucht, wenn ein Spieler einer Gruppe beitritt oder sie verlässt, verändert, um sie informativer zu machen." -- Needs review
L["options.widget.enhanceGroupRelatedSystemMessages.desc.2"] = "Zum Beispiel, die Nachricht:" -- Needs review
...
L["word.or"] = "oder"
L["word.party"] = "Gruppe"
L["word.raid"] = "Schlachtzug" -- Needs review
