...
L["sorter.mode.THMUR"] = "Tanks>Heiler>Nahkämpfer>Fernkämpfer" -- Needs review
L["sorter.mode.TMURH"] = "Tanks>Nahkämpfer>Fernkämpfer>Heiler" -- Needs review
L["sorter.print.alreadySorted"] = "Keine Änderung - der Schlachtzug ist bereits sortiert." -- Needs review
L["sorter.print.alreadySplit"] = "Keine Änderung - der Schlachtzug ist bereits aufgeteilt."
L["sorter.print.combatCancelled"] = "Die Umordnung der Spieler wurde, aufgrund des Kampfes, abgebrochen." -- Needs review
L["sorter.print.combatPaused"] = "Die Umordnung der Spieler wurde, aufgrund des Kampfes, pausiert." -- Needs review
L["sorter.print.combatResumed"] = "Umordnung der Spieler fortgesetzt." -- Needs review
...
L["sorter.print.timedOut"] = "Die Umordnung der Spieler wurde gestoppt, weil es zu lange dauert. Vielleicht ordnet jemand anderes gleichzeitig Spieler um?" -- Needs review
