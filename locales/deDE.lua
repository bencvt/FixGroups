...
L["choose.print.choosing.sitting.noGroups"] = "sitzender Spieler" -- Needs review
L["choose.print.chose.option"] = "Wähle Option #%d: %s."
L["choose.print.chose.player"] = "Wähle Option #%d: %s in Gruppe %d."
L["choose.print.last"] = "Der letzte Befehl wird wiederholt%s."
...
L["gui.fixGroups.help.list"] = "Listet Spieler, die einem bestimmten Kriterium entsprechen, im Schlachtzug-Chat auf." -- Needs review
-- L["gui.fixGroups.help.listself"] = ""
L["gui.fixGroups.help.nosort"] = "Gruppen festlegen, keine Sortierung."
...
L["gui.fixGroups.intro"] = "Der %s (oder %s) Befehl erlaubt dir, das Addon ohne Verwendung des GUIs zu steuern. Du kannst diesen Befehl in einem Makro verwenden oder du gibst ihn einfach in den Chat ein."
...
L["options.widget.addButtonToRaidTab.desc"] = "Fügt dem Schlachtzug-Reiter des Standard-Blizzard-UIs den %s Button hinzu, dieser funktioniert genauso wie das Minikarten-Symbol. Die Tastaturbelegung, um den Schlachtzug-Reiter zu öffnen, ist %s." -- Needs review
...
L["sorter.mode.nosort"] = "keine Sortierung"
-- L["sorter.mode.split"] = ""
...
L["tooltip.right.gui"] = "Andere Umordnungsmodi"
